...
const setAnalyticsCookie = (
  ...
  if (
    req?.query?.cookies === acceptLabel &&
    req?.query?.cookies !== undefined
  ) {
  ...
  if (
    req.cookies["cm-user-preferences"] === acceptLabel &&
