import { InstructorFindTestCentreController } from "@controllers/instructor-find-test-centre/instructor-find-test-centre";
...
describe("Instructor Find Test Centre controller", () => {
  ...
  describe("GET", () => {
    test("should render find-test-centre, first time", () => {
      ...
      expect(res.render).toHaveBeenCalledWith("instructor/find-test-centre", {
    ...
    test("missing journey on session", () => {
      ...
      expect(() => findTestCentreController.get(req, res)).toThrow(
        Error("InstructorFindTestCentreController::get: No journey set")
      );
    });
    ...
    test("missing booking on session", () => {
      ...
      expect(() => findTestCentreController.get(req, res)).toThrow(
        Error("InstructorFindTestCentreController::get: No currentBooking set")
      );
    });
  });
  ...
  describe("POST", () => {
    ...
    test("missing journey on session", () => {
      ...
      expect(() => findTestCentreController.post(req, res)).toThrow(
        Error("InstructorFindTestCentreController::post: No journey set")
      );
    });
    ...
    test("missing booking on session", () => {
      ...
      expect(() => findTestCentreController.post(req, res)).toThrow(
        Error("InstructorFindTestCentreController::post: No currentBooking set")
      );
    });
  });
});
