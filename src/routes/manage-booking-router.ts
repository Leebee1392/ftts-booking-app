...
import {
  manageReschedulingAuth,
  manageBookingNsaAuth,
  manageBookingHomeAuth,
  manageBookingViewAuth,
} from "../middleware/auth";

export const manageBookingRouter = express.Router();

manageBookingRouter.get(
  ["/", "/login"],
  setupSession,
  setTarget,
  internationalisation,
  setContext,
  manageBookingLogin.get
);
manageBookingRouter.post(
  ["/login"],
  validateRequest(manageBookingLogin.postSchemaValidation),
  asyncErrorHandler(manageBookingLogin.post)
);
manageBookingRouter.get(
  ["/home"],
  manageBookingHomeAuth,
  asyncErrorHandler(manageBookingHome.get)
);
manageBookingRouter.get(
  ["/manage-change-location-time/:ref"],
...
manageBookingRouter.post(
  ...
  selectTestCentre.post
);
manageBookingRouter.get(
  ["/check-change"],
  manageReschedulingAuth,
  manageBookingCheckChange.get
);
manageBookingRouter.post(
  ["/check-change"],
  manageReschedulingAuth,
  asyncErrorHandler(manageBookingCheckChange.post)
);
manageBookingRouter.get(
  ["/check-change/reset"],
  manageReschedulingAuth,
  manageBookingCheckChange.reset
);
manageBookingRouter.get(
  ["/test-language"],
  manageReschedulingAuth,
...
manageBookingRouter.get(
  ["/request-refund"],
  manageBookingHomeAuth,
  manageBookingRequestRefund.get
);
manageBookingRouter.post(
  ["/request-refund"],
  manageBookingHomeAuth,
  asyncErrorHandler(manageBookingRequestRefund.post)
);
manageBookingRouter.get(
  ["/:ref"],
  manageBookingViewAuth,
  asyncErrorHandler(manageBookingChange.get)
);
manageBookingRouter.get(
  ["/:ref/cancel"],
  manageBookingViewAuth,
  manageBookingCancel.get
);
manageBookingRouter.post(
  ["/:ref/cancel"],
  manageBookingViewAuth,
  asyncErrorHandler(manageBookingCancel.post)
);
manageBookingRouter.get(
  ["/error-technical"],
