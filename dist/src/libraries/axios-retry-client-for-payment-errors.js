...
exports.AxiosRetryClientForPaymentErrors = void 0;
const axios_1 = __importDefault(require("axios"));
const axios_retry_1 = __importStar(require("axios-retry"));
const axios_retry_client_helper_1 = require("./axios-retry-client-helper");
class AxiosRetryClientForPaymentErrors {
    ...
    setupAxiosRetry() {
        axios_retry_1.default(this.axiosRetryClient, {
            ...
            retryCondition: (err) => !axios_retry_client_helper_1.isUserCancelledError(err) &&
                !axios_retry_client_helper_1.isGatewayError(err) &&
                !axios_retry_client_helper_1.isSystemError(err) &&
                (axios_retry_1.isNetworkError(err) || axios_retry_1.isRetryableError(err) || axios_retry_client_helper_1.is429Error(err)),
            retryDelay: (retryCount, err) => axios_retry_client_helper_1.calculateRetryDelay(retryCount, err, this.retryPolicy),
        });
    }
}
exports.AxiosRetryClientForPaymentErrors = AxiosRetryClientForPaymentErrors;
