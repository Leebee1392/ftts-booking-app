...
exports.ConfirmSupportController = exports.ConfirmSupportOption = void 0;
...
class ConfirmSupportController {
    constructor() {
        this.get = (req, res) => {
        ...
        this.render = (req, res) => res.render("supported/confirm-support", {
            errors: req.errors,
...
exports.ConfirmSupportController = ConfirmSupportController;
exports.default = new ConfirmSupportController();
