...
const mockCentres: Centre[] = [
  {
    ...
    siteId: "Site042",
    description:
      "Rerum architecto iste illum hic ea unde consequatur repellendus et. Ut quo suscipit vel laboriosam accusantium exercitationem quam neque. Illo est facilis accusamus dolore. Laboriosam et dicta quasi et eum atque. At quas vel deserunt distinctio. Id labore eum.",
  ...
  },
  {
    ...
    siteId: "Site024",
    description:
      "Quae aut labore porro consectetur possimus ut voluptas ut. Libero qui magnam aut inventore voluptatem sed quia a. Voluptas delectus vel eos consequatur debitis nam minima. Architecto et voluptatem omnis pariatur et repudiandae culpa.",
    accessible: "Disabled access",
    fullyAccessible: true,
  ...
  },
  {
    ...
    siteId: "Site031",
    description:
      "Molestiae dolore sapiente ipsum praesentium amet sint. Inventore earum commodi voluptatem dolore minima maxime minus omnis.",
    accessible: "Disabled access",
