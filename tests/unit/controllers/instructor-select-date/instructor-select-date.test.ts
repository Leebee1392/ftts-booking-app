...
import selectDateController from "@controllers/instructor-select-date/instructor-select-date";
...
describe("Instructor Select Date controller", () => {
  ...
  describe("GET", () => {
    test("renders the view with correct data", () => {
      ...
      expect(res.render).toHaveBeenCalledWith("instructor/select-date", {
