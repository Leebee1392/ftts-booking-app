...
export const App = (): Express => {
  ...
  app.use(
    "/public/javascripts",
    express.static(path.join(__dirname, "assets/javascripts"))
  );
  app.use(
    "/public/langs",
    express.static(path.join(__dirname, "assets/langs"))
  );
  app.use(
    "/public/stylesheets",
    express.static(path.join(__dirname, "assets/stylesheets"))
  );
