import { ReceivedSupportRequestController } from '@controllers/received-support-request/received-support-request';
  ...
  describe('get', () => {
    describe('get - non-standard accomdation', () => {
      test('it should render the correct page with the back link as the test type page and continue link as the test language page', () => {
        ...
        expect(res.render).toHaveBeenCalledWith('common/received-support-request', {
          backLink: 'test-type',
