...
export class InstructorConfirmSupportController {
  ...
  public post = (req: Request, res: Response): void => {
    if (!req.session.journey) {
      throw Error(
        "InstructorConfirmSupportController::post: Missing journey session data"
      );
    }
  ...
  private render = (req: Request, res: Response): void =>
    res.render("instructor/confirm-support", {
      errors: req.errors,
...
export default new InstructorConfirmSupportController();
