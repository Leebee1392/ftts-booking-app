import { InstructorPreferredLocationController } from "@controllers/instructor-preferred-location/instructor-preferred-location";
...
describe("Preferred Location controller", () => {
  ...
  describe("GET request", () => {
    test("renders the preferred location page with saved text & options", () => {
      ...
      expect(res.render).toHaveBeenCalledWith("instructor/preferred-location", {
        errors: [],
  ...
  describe("POST request", () => {
    ...
    test("selecting decide later will still save the users text", () => {
      ...
      expect(req.session.currentBooking.preferredLocation).toStrictEqual(
        "new text"
      );
