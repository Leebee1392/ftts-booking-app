...
exports.TelephoneContactController = void 0;
const enums_1 = require("../../domain/enums");
const language_1 = require("../../helpers/language");
class TelephoneContactController {
    constructor() {
        this.get = (req, res) => {
...
exports.TelephoneContactController = TelephoneContactController;
exports.default = new TelephoneContactController();
