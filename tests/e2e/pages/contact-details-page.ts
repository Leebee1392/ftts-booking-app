...
export class ContactDetailsPage extends BasePage {
  ...
  invalidConfirmationEmailErrorText =
    "Enter a valid confirmation email address";

  confirmEmailMatchesErrorText =
  ...
  updateEmailBannerText =
    "You can change the email address associated with this booking or keep the last one saved.";
