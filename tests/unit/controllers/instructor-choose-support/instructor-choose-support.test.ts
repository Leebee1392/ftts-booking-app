import { InstructorChooseSupportController } from '@controllers/instructor-choose-support/instructor-choose-support';
...
describe('Instructor Choose Support controller', () => {
  ...
  describe('GET', () => {
    test('renders the view with correct data', () => {
      ...
      expect(res.render).toHaveBeenCalledWith('instructor/choose-support', {
