...
exports.default = {
    ...
    buildBody: (details) => {
        ...
        if (details.lastRefundDate) {
            cancelWarning = ` Os bydd yr archeb hon yn cael ei newid neu ei chanslo ar ôl dydd ${local_date_time_filter_1.asFullDateWithoutWeekday(details.lastRefundDate)} ni roddir ad-daliad.`;
        }
        return ts_dedent_1.default `
    # Mae manylion eich prawf theori gyrru wedi'u diweddaru
    ...
    Os nad oeddech wedi diweddaru'r prawf hwn, cysylltwch â ni ar unwaith. Gallwch ymateb i'r e-bost hwn neu ffonio 0300 2001122.
    ...
    ${local_date_time_filter_1.asLocalTime(details.testDateTime)} ${local_date_time_filter_1.asFullDateWithWeekday(details.testDateTime)}
    ...
    2. dod â'u trwydded yrru
    (dylai deiliaid sy'n berchen ar yr hen ddull o drwydded papur hefyd ddod â phasport dilys)
    ...
    Wrth i chi fynd i mewn i'r ystafell prawf, gwirir nad oes eitemau gennych y gellid eu defnyddio i dwyllo. Ni fydd eich prawf yn cael ei gynnal os na fyddwch yn caniatáu i’r gwiriad hwn ddigwydd.
    ...
    * mae'n bosibl na ad-delir ffi'r prawf
    ...
    Gwiriwch fanylion y prawf hwn yma:
    https://www.gov.uk/check-theory-test

    Aildrefnwch y prawf yma:
    https://www.gov.uk/change-theory-test

    Canslwch y prawf hwn yma:
