...
import {
  buildBookingCancellationEmailContent,
  buildBookingConfirmationEmailContent,
  buildBookingRescheduledEmailContent,
  buildRefundRequestEmailContent,
  buildSupportRequestDetails,
  ...
  email: {
    0: {
      ...
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB booking confirmation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY booking confirmation subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY booking confirmation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI booking confirmation subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI booking confirmation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    1: {
      ...
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB booking cancellation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY booking cancellation subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY booking cancellation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI booking cancellation subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI booking cancellation body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    2: {
      // Booking rescheduled
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB booking rescheduled body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY booking rescheduled subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY booking rescheduled body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI booking rescheduled subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI booking rescheduled body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    3: {
      // Evidence required
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB evidence required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY evidence required subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY evidence required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI evidence required subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI evidence required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    4: {
      ...
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB evidence not required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY evidence not required subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY evidence not required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI evidence not required subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI evidence not required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    5: {
      ...
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB evidence may be required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY evidence may be required subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY evidence may be required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI evidence may be required subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI evidence may be required body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    6: {
      // Support request
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB support request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY support request subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY support request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI support request subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI support request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
    7: {
      // Refund request
      gb: {
        ...
        buildBody: (mockDetails: MockDetails) =>
          `GB refund request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      cy: {
        subject: "CY refund request subject",
        buildBody: (mockDetails: MockDetails) =>
          `CY refund request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
      ni: {
        subject: "NI refund request subject",
        buildBody: (mockDetails: MockDetails) =>
          `NI refund request body with ${mockDetails.placeholder1} and ${mockDetails.placeholder2}`,
      },
    },
  },
}));
...
describe("Notifications content builders", () => {
  describe("buildBookingConfirmationEmailContent", () => {
    ...
    test("builds GB email content with placeholder values given GB target", () => {
      ...
      const content = buildBookingConfirmationEmailContent(
        mockDetails as any,
        mockTarget,
        mockLang
      );
  ...
  describe("buildReturningCandidateEmailContent", () => {
    ...
    test("builds GB email content with placeholder values given GB target", () => {
      ...
      const content = buildReturningCandidateEmailContent(
        mockDetails as any,
        mockTarget,
        mockLang
      );
  ...
  describe("buildRefundRequestEmailContent", () => {
    ...
    test("builds GB email content with placeholder values given GB target", () => {
      ...
      const content = buildRefundRequestEmailContent(
        mockDetails as any,
        mockTarget,
        mockLang
      );
