import { SelectTestCentreController } from '@controllers/select-test-centre/select-test-centre';
...
describe('SelectTestCentreController', () => {
  ...
  describe('get', () => {
    test('should update the number of results in the session if one is provided via query string', async () => {
      ...
      expect(res.render).toHaveBeenCalledWith('select-test-centre', {
        centres: mockCentres,
    ...
    describe('html escaping', () => {
      ...
      test('passes an html-escaped address for the frontend js map to use', async () => {
        ...
        expect(res.render).toHaveBeenCalledWith('select-test-centre', expect.objectContaining({
  ...
  describe('post', () => {
    ...
    test('re-renders page if has errors', async () => {
      ...
      expect(res.render).toHaveBeenLastCalledWith('select-test-centre', expect.any(Object));
    });
