import { InstructorBritishSignLanagugeController } from "@controllers/instructor-british-sign-language/instructor-british-sign-language";
...
describe("InstructorBritishSignLanagugeController", () => {
  ...
  describe("get", () => {
    test("correctly renders page in edit mode and bsl is set to true", () => {
      ...
      expect(res.render).toHaveBeenCalledWith(
        "instructor/british-sign-language",
        {
          chosenBSL: YesNo.YES,
          bookingRef: mockBookingRef,
          errors: [],
  ...
  describe("postSchemaValidation", () => {
    test("schema validation matches", () => {
      ...
      expect(controller.postSchemaValidation).toStrictEqual(
