...
exports.InstructorChangeLocationTime = void 0;
...
class InstructorChangeLocationTime {
    constructor() {
        this.get = (req, res) => {
            var _a;
        ...
        this.renderPage = (req, res) => {
            res.render("instructor/change-location-time", {
...
exports.InstructorChangeLocationTime = InstructorChangeLocationTime;
exports.default = new InstructorChangeLocationTime();
