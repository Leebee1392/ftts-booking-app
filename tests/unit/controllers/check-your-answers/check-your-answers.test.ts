...
import { CheckYourAnswersController } from "@controllers/check-your-answers/check-your-answers";
...
describe("Check Your Answers controller", () => {
  ...
  beforeEach(() => {
    ...
    checkYourAnswers = new CheckYourAnswersController(
  ...
  describe("GET request", () => {
    test("renders check-your-answers template", () => {
      ...
      expect(res.render).toHaveBeenCalledWith("create/check-your-answers", {
        firstNames: "Test",
        surname: "User",
        dateOfBirth: "1990-01-01",
        licenceNumber: "JONES061102W97YT",
