...
const toLocale = (target: Target, lang: Locale): Locale =>
  target === Target.NI ? Locale.NI : lang;

export const buildBookingConfirmationEmailContent = (
  details: BookingConfirmationDetails,
  target: Target,
  lang: Locale
): EmailContent => {
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.BOOKING_CONFIRMATION][locale];
  return {
    subject,
...
export const buildBookingCancellationEmailContent = (
  ...
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.BOOKING_CANCELLATION][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildBookingRescheduledEmailContent = (
  ...
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.BOOKING_RESCHEDULED][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildEvidenceRequiredEmailContent = (
  ...
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.EVIDENCE_REQUIRED][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildEvidenceNotRequiredEmailContent = (
  details: SupportRequestDetails,
  target: Target,
  lang: Locale
): EmailContent => {
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.EVIDENCE_NOT_REQUIRED][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildEvidenceMayBeRequiredEmailContent = (
  details: SupportRequestDetails,
  target: Target,
  lang: Locale
): EmailContent => {
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.EVIDENCE_MAY_BE_REQUIRED][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildReturningCandidateEmailContent = (
  details: SupportRequestDetails,
  target: Target,
  lang: Locale
): EmailContent => {
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.RETURNING_CANDIDATE][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildRefundRequestEmailContent = (
  ...
  const locale = toLocale(target, lang);
  const { subject, buildBody } =
    content.email[EmailType.REFUND_REQUEST][locale];
  return {
    subject,
    body: buildBody(details),
  };
...
export const buildSupportRequestDetails = (
  booking: Booking,
  target: Target
): SupportRequestDetails => ({
