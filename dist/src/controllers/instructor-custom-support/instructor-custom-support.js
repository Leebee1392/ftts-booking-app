...
exports.InstructorCustomSupportController = void 0;
...
class InstructorCustomSupportController {
    constructor() {
        this.get = (req, res) => this.render(req, res);
        this.post = (req, res) => {
            var _a;
            if (!req.session.journey) {
                throw Error("InstructorCustomSupportController::post: No journey set");
            }
        ...
        this.render = (req, res) => {
            var _a;
            res.render("instructor/custom-support", {
                errors: req.errors,
        ...
        this.getBackLink = (req) => {
            if (!req.session.journey) {
                throw Error("InstructorCustomSupportController::getBackLink: No journey set");
            }
            const { inEditMode } = req.session.journey;
            return inEditMode
                ? "check-your-details"
...
exports.InstructorCustomSupportController = InstructorCustomSupportController;
exports.default = new InstructorCustomSupportController();
