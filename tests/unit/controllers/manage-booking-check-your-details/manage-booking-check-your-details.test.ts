...
import { ManageBookingCheckYourDetailsController } from "@controllers/manage-booking-check-your-details/manage-booking-check-your-details";
import {
...
import {
  bookingDetailsBuilder,
  candidateBuilder,
} from "../../../mocks/data/builders";
...
describe("check-your-details", () => {
  ...
  const mockBooking: BookingDetails = bookingDetailsBuilder(
    true,
  ...
  describe("GET", () => {
    test("when called, returns the correct booking and candidate information", () => {
      ...
      mockBooking.testSupportNeed = [
        CRMTestSupportNeed.BSLInterpreter,
        CRMTestSupportNeed.ExtraTime,
      ];
      ...
      expect(res.render).toHaveBeenCalledWith(
        "manage-booking/check-your-details",
        {
          target: Target.GB,
          ...
          supportTypes: [
            TestSupportNeed.BSLInterpreter,
            TestSupportNeed.ExtraTime,
          ],
