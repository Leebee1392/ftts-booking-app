...
import {
  VoiceoverBody,
  InstructorVoiceoverController,
} from "@controllers/instructor-voiceover/instructor-voiceover";
  ...
  describe("GET", () => {
    describe("Managed Booking Edit Mode", () => {
      test("renders the page in GB manage booking mode", () => {
        ...
        expect(res.render).toHaveBeenCalledWith("instructor/voiceover", {
          radioItems: [
            {
              checked: false,
      ...
      test("missing journey handled", () => {
        ...
        expect(() => voiceoverController.get(req, res)).toThrow(
          Error("InstructorVoiceoverController::get: No journey set")
        );
      });
      ...
      test("missing booking handled", () => {
        ...
        expect(() => voiceoverController.get(req, res)).toThrow(
          Error(
            "InstructorVoiceoverController::renderPage: No Current Booking object found in session"
          )
        );
      });
    });
  ...
  describe("POST", () => {
    ...
    describe("Error Handling", () => {
      ...
      test("renders same page with errors on bad request", () => {
        ...
        expect(res.render).toHaveBeenLastCalledWith("instructor/voiceover", {
          radioItems: [
            {
              checked: false,
              text: "translated translated",
      ...
      test("missing journey handled", () => {
        ...
        expect(() => voiceoverController.post(req, res)).toThrow(
          Error("InstructorVoiceoverController::post: No journey set")
        );
      });
