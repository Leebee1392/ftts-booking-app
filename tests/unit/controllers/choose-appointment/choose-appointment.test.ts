...
import { ChooseAppointmentBody, ChooseAppointmentController } from '@controllers/choose-appointment/choose-appointment';
...
describe('Choose appointment controller', () => {
  ...
  describe('GET request', () => {
    ...
    test('renders the page with errors when there are errors', async () => {
      ...
      expect(res.render).toHaveBeenCalledWith('common/choose-appointment', expect.objectContaining({
        errors: req.errors,
      }));
    });
