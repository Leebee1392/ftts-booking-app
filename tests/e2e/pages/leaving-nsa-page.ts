...
export class LeavingNsaPage extends BasePage {
  ...
  // Contents
  pageHeading =
    "You do not need to provide evidence for the support type you selected";

  para1 = "You can select 'Continue' to book your theory test online now.";

  para2 =
    "Or, if you prefer, select 'Ask us to contact you about support' and we'll contact you to:";
