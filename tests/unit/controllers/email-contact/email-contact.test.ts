...
} from "../../../../src/helpers/journey-helper";
...
describe("Contact details", () => {
  describe("Schema validation checks", () => {
    test("POST request", () => {
      expect(emailContact.postSchemaValidation()).toEqual(
  ...
  describe("Requests", () => {
    ...
    describe("Helpers", () => {
      test("validate matching emails", () => {
        ...
        const email = emailContact.matchingEmailValidator("a@test.com", {
          req,
        } as any);
      ...
      test("empty email string throws error", () => {
        ...
        const errorMessage =
          "Ensure confirmation email address matches email address";
        translate.mockImplementation(() => errorMessage);

        expect(() =>
          emailContact.matchingEmailValidator("", { req } as any)
      ...
      test("non matching emails throws error", () => {
        ...
        expect(() =>
          emailContact.matchingEmailValidator("a@test.com", { req } as any)
        ).toThrow(errorMessage);
      });
    });
  });
