...
export const centreBuilder = (): Centre =>
  build<Centre>({
    fields: {
      ...
      addressPostalCode: `${faker.address.countryCode(
        "alpha-3"
      )} ${faker.address.countryCode("alpha-3")}`,
      addressCountryRegion: faker.helpers.arrayElement([
        "England",
        "Wales",
        "Scotland",
        "Northern Ireland",
...
export const bookingDetailsCentreBuilder = (): BookingDetailsCentre =>
  build<BookingDetailsCentre>({
    fields: {
      testCentreId: faker.datatype.uuid(),
      name: faker.company.name(),
      addressLine1: faker.address.secondaryAddress(),
...
export const crmTestCentreBuilder = (): CRMTestCentre =>
  build<CRMTestCentre>({
    fields: {
      ...
      address1_postalcode: `${faker.address.countryCode(
        "alpha-3"
      )} ${faker.address.countryCode("alpha-3")}`,
