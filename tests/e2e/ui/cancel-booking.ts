...
test("Verify UI contents of the Cancel this theory test booking page", async (t) => {
  ...
  await verifyTitleContainsText(
    `${cancelBookingPage.pageHeading} ${generalTitle}`
  );
  ...
  await verifyExactText(
    cancelBookingPage.cancelButtonLocator,
    cancelBookingPage.confirmCancellationButtonText
  );
  await verifyExactText(
    cancelBookingPage.keepButtonLocator,
    cancelBookingPage.keepExistingBookingButtonText
  );
  await verifyExactText(
    cancelBookingPage.messageLocator,
    cancelBookingPage.messageText,
    0
  );
  await verifyExactText(
    cancelBookingPage.keepButtonLocator,
  ...
  await verifyExactText(
    cancelBookingPage.textLocator1,
    cancelBookingPage.text1,
    0
  );
  await verifyExactText(
    cancelBookingPage.textLocator4,
    cancelBookingPage.text2,
    3
  );
  await verifyExactText(
    cancelBookingPage.textLocator3,
    cancelBookingPage.text3
  );
  await verifyExactText(
    cancelBookingPage.textLocator4,
    cancelBookingPage.text4,
    4
  );
  await verifyExactText(
    cancelBookingPage.textLocator4,
    cancelBookingPage.text5,
    5
  );
  await verifyExactText(
    cancelBookingPage.textLocator6,
    cancelBookingPage.text6
  );
  if (!runningTestsLocally()) {
