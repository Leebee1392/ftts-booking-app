...
export class TestLanguage {
  ...
  public static fromCRMTestLanguage(
    crmTestLanguage: CRMTestLanguage
  ): TestLanguage {
  ...
  public static canChangeTestLanguage = (
    target: Target,
    testType: TestType
  ): boolean => !(target === Target.NI || testType === TestType.ERS);
  ...
  private static readonly CRM_TEST_LANGUAGE_MAP: Map<
    CRMTestLanguage,
    Language
  > = new Map([
