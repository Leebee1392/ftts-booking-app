...
export const crmTestSupportNeed = Object.values(
  CRMTestSupportNeed
) as CRMTestSupportNeed[];
export const genderTypes = Object.values(
  CandidateDetails.GenderEnum
) as CandidateDetails.GenderEnum[];
