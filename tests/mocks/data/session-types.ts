...
const mockSessionNsaBooking = (): Booking => ({
  ...
  selectSupportType: Object.values(SupportType).filter(
    (value) => value.toLowerCase() !== "translator"
  ),
  voicemail: true,
...
export { mockSessionBooking, mockSessionNsaBooking, mockSessionCandidate };
