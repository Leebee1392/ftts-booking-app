...
import {
  VoiceoverBody,
  VoiceoverController,
} from "@controllers/voiceover/voiceover";
  ...
  describe("GET", () => {
    describe("Managed Booking Edit Mode", () => {
      test("renders the page in GB manage booking mode", () => {
        ...
        expect(res.render).toHaveBeenCalledWith("common/voiceover", {
          radioItems: [
            {
              checked: false,
  ...
  describe("POST", () => {
    ...
    describe("Error Handling", () => {
      ...
      test("renders same page with errors on bad request", () => {
        ...
        expect(res.render).toHaveBeenLastCalledWith("common/voiceover", {
          radioItems: [
            {
              checked: false,
              text: "translated translated",
