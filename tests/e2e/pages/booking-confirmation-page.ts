...
export class BookingConfirmationPage extends BasePage {
  ...
  async checkDataMatchesSessionNSA(sessionData: SessionData, evidencePath: EvidencePath): Promise<void> {
    ...
    } else if (evidencePath === EvidencePath.EVIDENCE_NOT_REQUIRED || evidencePath === EvidencePath.EVIDENCE_MAY_BE_REQUIRED) {
  ...
  async checkHeadingsAppearCorrectlyNSA(evidencePath: EvidencePath): Promise<void> {
