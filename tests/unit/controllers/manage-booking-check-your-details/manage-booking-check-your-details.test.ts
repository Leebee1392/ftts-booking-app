...
describe('check-your-details', () => {
  ...
  describe('GET', () => {
    test('when called, returns the correct booking and candidate information', () => {
      ...
      expect(res.render).toHaveBeenCalledWith('manage-booking/check-your-details', {
        target: Target.GB,
    ...
    test('when candidate first name returns as \'---\' and target is in gb, render page with just surname', () => {
      ...
      expect(res.render).toHaveBeenCalledWith('manage-booking/check-your-details', expect.objectContaining({
