...
export class LanguagePage extends BasePage {
  ...
  // Contents
  pageHeading =
    "Which language do you want to appear on screen during the theory test?";
  ...
  updateLanguageBannerText =
    "You can change the test language or keep your existing choice.";
