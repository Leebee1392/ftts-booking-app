import { InstructorPreferredDayController } from '@controllers/instructor-preferred-day/instructor-preferred-day';
...
describe('Instructor Preferred Day controller', () => {
  ...
  describe('GET request', () => {
    test('renders the preferred day page with saved text & options', () => {
      ...
      expect(res.render).toHaveBeenCalledWith('instructor/preferred-day', {
        errors: [],
