import { CheckYourDetailsController } from "@controllers/check-your-details/check-your-details";
import {
  Language,
  TestType,
  Voiceover,
...
describe("Check Your Details controller", () => {
  ...
  describe("GET request", () => {
    test("renders check-your-details page", () => {
      ...
      expect(res.render).toHaveBeenCalledWith("supported/check-your-details", {
        firstNames: "Test",
        surname: "User",
        dateOfBirth: "1990-01-01",
        licenceNumber: "JONES061102W97YT",
