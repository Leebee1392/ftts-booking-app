...
describe("Logger", () => {
  ...
  test("logs critical", () => {
    ...
    expect(AzureLogger.prototype.critical).toHaveBeenCalledWith(
      msg,
  ...
  test("logs warning", () => {
    ...
    expect(AzureLogger.prototype.warn).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs event", () => {
    ...
    expect(AzureLogger.prototype.event).toHaveBeenCalledWith(
      "event name",
      msg,
      expect.objectContaining({
        ...props,
  ...
  test("logs request", () => {
    ...
    expect(AzureLogger.prototype.request).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs dependency", () => {
    ...
    expect(AzureLogger.prototype.dependency).toHaveBeenCalledWith(
      msg,
      "data",
      expect.objectContaining({
        ...props,
  ...
  test("logs security", () => {
    ...
    expect(AzureLogger.prototype.security).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs audit", () => {
    ...
    expect(AzureLogger.prototype.audit).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs log", () => {
    ...
    expect(AzureLogger.prototype.log).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs info", () => {
    ...
    expect(AzureLogger.prototype.info).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
  ...
  test("logs debug", () => {
    ...
    expect(AzureLogger.prototype.debug).toHaveBeenCalledWith(
      msg,
      expect.objectContaining({
        ...props,
        sessionId: mockSessionId,
