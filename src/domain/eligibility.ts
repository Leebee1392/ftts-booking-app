...
const DVA_ONLY_TEST_TYPES = [TestType.TAXI, TestType.LGVCPCC, TestType.PCVCPCC];
...
const ZERO_COST_TEST_TYPES = [TestType.ADIP1DVA, TestType.AMIP1];
 ...
 */
export const isBookable = (eligibility: Eligibility, target: Target): boolean =>
...
export const isInstructorBookable = (
...
export const hasBehaviouralMarkerForTest = (
  testDate: string,
  behaviouralMarker?: boolean,
  behaviouralMarkerExpiryDate?: string
): boolean => {
...
export const isZeroCostTest = (testType: TestType): boolean =>
  ZERO_COST_TEST_TYPES.includes(testType);
