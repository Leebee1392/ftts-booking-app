...
describe("CRM Gateway", () => {
  ...
  describe("getLicenceNumberRecordsByCandidateId", () => {
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.getLicenceNumberRecordsByCandidateId(
          "candidateIDInvalid",
          "licenceInvalid"
        )
  ...
  describe("createLicence", () => {
    test("calls CRM and successfully creates a licence for a candidate and returns new licence id", async () => {
      ...
      const response = await crmGateway.createLicence(
        mockCandidate.licenceNumber as string,
        mockCandidate.address as ELIG.Address,
        mockCandidate.candidateId as string
      );
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::createLicence: Creating licence record in CRM",
        { candidateId: mockCandidate.candidateId }
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
        "CRMGateway::createLicence: Successfully created licence in CRM",
        { candidateId: mockCandidate.candidateId, licenceId }
      );
      expect(logger.error).not.toHaveBeenCalled();
      expect(logger.event).not.toHaveBeenCalled();
    });
  ...
  describe("createCandidate", () => {
    test("calls CRM and successfully creates a new candidate and returns new candidate id", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::createCandidate: Creating candidate in CRM"
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
    ...
    test("handles error if call to CRM fails", async () => {
      ...
      await expect(crmGateway.createCandidate(mockCandidate)).rejects.toEqual(
        mockError
      );
  ...
  describe("updateCandidate", () => {
    test("successfully calls CRM to update the candidate and doesn't throw an error", async () => {
      ...
      const response = await crmGateway.updateCandidate(
        mockCandidate.candidateId as string,
        {
      ...
      const { line1, line2, line3, line4, line5, postcode } =
    ...
    test("throws error if CRM call is unsuccessful", async () => {
      ...
      await expect(
        crmGateway.updateCandidate(mockCandidateId, {
  ...
  describe("updateLicence", () => {
    test("successfully calls CRM to update a licence record", async () => {
      ...
      const response = await crmGateway.updateLicence(
        licenceId,
        candidateId,
    ...
    test("error gets handled when call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateLicence(licenceId, candidateId, mockCandidate.address)
      ).rejects.toEqual(error);
  ...
  describe("updateCandidateAndCreateBooking", () => {
    test("successfully calls CRM to update candidate record when telephone, email and address are different and creates a booking", async () => {
      ...
      const response = await crmGateway.updateCandidateAndCreateBooking(
        mockCandidate,
        mockBooking,
    ...
    test("throws a CrmCreateBookingDataError when crm returns wrong data and retries are not successful", async () => {
      ...
      const error = new CrmCreateBookingDataError(
        "CRMGateway::validateBookingAndRetryIfNeeded: crm returned data from different booking"
      );

      await expect(
        crmGateway.updateCandidateAndCreateBooking(
          mockCandidate,
          mockBooking,
          CRMAdditionalSupport.None,
  ...
  describe("createBookingProduct", () => {
    test("successfully calls CRM to create a Booking Product and returns its id", async () => {
      ...
      const result = await crmGateway.createBookingProduct(
        mockCandidate,
        mockBooking,
        mockBookingResponse,
        standardAccommodation,
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.createBookingProduct(
          mockCandidate,
          mockBooking,
          mockBookingResponse,
          standardAccommodation,
  ...
  describe("rescheduleBookingAndConfirm", () => {
    test("successfully calls CRM to update the booking time and date of a given booking & changes status to confirmed", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        ...
        { bookingId, dateTime, rescheduleCount: 1 }
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.rescheduleBookingAndConfirm(bookingId, dateTime, 0)
      ).rejects.toEqual(error);
  ...
  describe("updateBookingStatus", () => {
    test("successfully calls CRM to update the booking status of a given booking", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
        "CRMGateway::updateBookingStatus: Booking status updated",
        { bookingId, crmBookingStatus }
      );
      expect(logger.error).not.toHaveBeenCalled();
      expect(logger.event).not.toHaveBeenCalled();
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateBookingStatus(bookingId, crmBookingStatus)
      ).rejects.toEqual(error);
  ...
  describe("markBookingCancelled", () => {
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.markBookingCancelled(bookingId, bookingProductId)
      ).rejects.toEqual(error);
  ...
  describe("updateVoiceover", () => {
    test("successfully calls CRM to update the voiceover of a given booking", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::updateVoiceover: Attempting to update voicover",
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateVoiceover(bookingId, bookingProductId, voiceover)
      ).rejects.toEqual(error);
  ...
  describe("updateAdditionalSupport", () => {
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateAdditionalSupport(
          bookingId,
          bookingProductId,
          additionalSupport
        )
  ...
  describe("updateLanguage", () => {
    ...
    test("successfully calls CRM to update the booking language of a given booking", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::updateLanguage: Attempting to update language",
        { bookingId, bookingProductId, language }
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
        "CRMGateway::updateLanguage: Language updated successfully",
        { bookingId, bookingProductId, language }
      );
      expect(logger.error).not.toHaveBeenCalled();
      expect(logger.event).not.toHaveBeenCalled();
    ...
    test("CSC bookings - successfully calls CRM to update the booking language of a given booking", async () => {
      await crmGateway.updateLanguage(
        bookingId,
        bookingProductId,
        language,
        true
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateLanguage(bookingId, bookingProductId, language)
      ).rejects.toEqual(error);
  ...
  describe("updateCompensationBooking", () => {
    ...
    test("throws an error if the call to CRM fails", async () => {
      ...
      await expect(
        crmGateway.updateCompensationBooking(
          mockBookingId,
          owedCompensationBookingRecognised
        )
      ).rejects.toThrow(error);
  ...
  describe("getCandidateBookings", () => {
    describe("ability to view nsa booking slots - false", () => {
      ...
      test("throws an error when the call to CRM fails", async () => {
        ...
        await expect(
          crmGateway.getCandidateBookings(candidateId)
        ).rejects.toEqual(error);
    ...
    describe("ability to view nsa booking slots - true", () => {
      ...
      test("correctly maps nsa booking slots to nsa bookings", async () => {
        ...
        result.forEach((mockResultBooking: BookingDetails) => {
          const nsaBookingSlotsResult =
            mockResultBooking.nsaBookingSlots as CRMNsaBookingSlots[];
          nsaBookingSlotsResult.forEach(
            (nsaBookingSlot: CRMNsaBookingSlots) => {
              // eslint-disable-next-line no-underscore-dangle
              expect(nsaBookingSlot._ftts_bookingid_value).toEqual(
                mockResultBooking.bookingId
              );
            }
          );
        });
  ...
  describe("getCandidateCompensatedBookings", () => {
    ...
    test("logs error when call to CRM to get candidates bookings which require compensation fail", async () => {
      ...
      await expect(
        crmGateway.getCandidateCompensatedBookings(candidateId, Target.GB)
  ...
  describe("createBindBetweenBookingAndPayment", () => {
    ...
    test("rethrows the error", async () => {
      mockedDynamicsWebApi.updateRequest.mockRejectedValue("Error");
      await expect(
        crmGateway.createBindBetweenBookingAndPayment(
          bookingId,
          paymentId,
          receiptReference
        )
  ...
  describe("calculateThreeWorkingDays", () => {
    ...
    test("returns an empty string if an error is thrown", async () => {
      ...
      expect(
        await crmGateway.calculateThreeWorkingDays(testDate, remit)
      ).toEqual("");
      expect(logger.error).toHaveBeenCalledTimes(1);
      expect(logger.error).toHaveBeenCalledWith(
        error,
  ...
  describe("getUserDraftNSABookingsIfExist", () => {
    test("returns a nsa booking if the user does have a draft NSA booking", async () => {
        ...
        value: [
          {
            ...
            ftts_selected: true,
            ftts_bookingproductid: "9afee4ea-43fc-eb11-94ef-000d3ad67a18",
            "ftts_booking.ftts_bookingid":
              "4cgee4ea-43fc-eb11-94ef-000d3ad67a18",
      ...
      expect(result).toStrictEqual([
        {
          bookingId: "4cgee4ea-43fc-eb11-94ef-000d3ad67a18",
          nsaStatus: 675030000,
          origin: 2,
        },
      ]);
  ...
  describe("doesCandidateHaveExistingBookingsByTestType", () => {
    ...
    test("rethrows error if an error occurs", async () => {
      ...
      await expect(
        crmGateway.doesCandidateHaveExistingBookingsByTestType(
          candidateId,
          TestType.CAR
        )
      ).rejects.toEqual(error);
      ...
      expect(logger.error).toHaveBeenCalledWith(
        ...
        { candidateId, testType: TestType.CAR }
      );
    });
  });
  ...
  describe("updateTCNUpdateDate", () => {
    ...
    test("throws an error if one occurs", async () => {
      ...
      await expect(
        crmGateway.updateTCNUpdateDate(bookingProductId)
      ).rejects.toEqual(error);
  ...
  describe("updateBookingStatusPaymentStatusAndTCNUpdateDate", () => {
    ...
    test("does a batch call to update the booking status and TCN update date together when bookingStatus is draft", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        ...
        { bookingId, bookingProductId, bookingStatus }
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
    ...
    test("throws an error if one occurs", async () => {
      ...
      await expect(
        crmGateway.updateBookingStatusPaymentStatusAndTCNUpdateDate(
          bookingId,
          bookingProductId,
          bookingStatus
        )
  ...
  describe("updateNSABookings", () => {
    test("when called with draft NSA bookings then bookings are updated in a batch", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::updateNSABookings: Attempting to update",
    ...
    test("throws an error if batch request fails", async () => {
      ...
      await expect(
        crmGateway.updateNSABookings(mockNsaBookingDetails)
      ).rejects.toEqual(error);
    ...
    test("throws an error if there are a thousand nsa bookings or exceed a thousand", async () => {
      const nsaBookings = [].concat(
        ...new Array(1000).fill([mockNsaBookingDetails[0]])
      );
      ...
      await expect(crmGateway.updateNSABookings(nsaBookings)).rejects.toThrow(
        error
      );
  ...
  describe("updateZeroCostBooking", () => {
    test("successfully calls CRM to update the booking and doesn't throw an error", async () => {
      ...
      expect(logger.info).toHaveBeenNthCalledWith(
        1,
        "CRMGateway::updateZeroCostBooking: Attempting to update",
        { bookingId }
      );
      expect(logger.info).toHaveBeenNthCalledWith(
        2,
    ...
    test("throws an error when the call to CRM fails", async () => {
      ...
      await expect(crmGateway.updateZeroCostBooking(bookingId)).rejects.toEqual(
        error
      );
  ...
  describe("getRescheduleCount", () => {
    ...
    test("throws error if empty response is received", async () => {
      ...
      await expect(() =>
        crmGateway.getRescheduleCount("mockBookingId")
      ).rejects.toThrow();
    });
  ...
  describe("logGeneralError", () => {
    test("handles 4xx error", () => {
      ...
      crmGateway.logGeneralError(error, "mockMessage", {
        example: "mock value",
      });
    ...
    test("handles 5xx error", () => {
      ...
      crmGateway.logGeneralError(error, "mockMessage2", {
        example: "mock value2",
      });
