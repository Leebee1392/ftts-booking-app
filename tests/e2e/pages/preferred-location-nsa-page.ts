...
export class PreferredLocationNSAPage extends BasePage {
  ...
  errorMessageTooManyCharsText =
    "The text you enter here must be 4000 characters or fewer";

  updateBannerText =
    "You can change your mind about this or you can keep your existing choice.";
  ...
  getRadioSelector(preferredLocation: PreferredLocation): string {
    return this.preferredLocationRadioLocator.replace(
      "<>",
      preferredLocation.toString()
    );
  }

  async selectPreferredLocationOption(
