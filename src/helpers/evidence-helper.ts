...
export const determineEvidenceRoute = (supportTypes: SupportType[], hasSupportNeedsInCRM: boolean): EvidencePath => {
  ...
  if (supportTypes.includes(SupportType.OTHER)) return EvidencePath.EVIDENCE_MAY_BE_REQUIRED;
